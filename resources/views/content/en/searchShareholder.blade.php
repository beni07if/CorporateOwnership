...
<section id="doctors" class="doctors">
    <div class="container">
        ...
        <div class="row pb-3 justify-content-center">
            <form action="{{ route('searchFunctionShareholder') }}" method="GET" class="d-flex" style="width: 33%; background-color: #f8f9fa; border-radius: 10px; padding: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                <input type="text" class="form-control me-2" name="shareholder_name" placeholder="Search for other shareholder company" style="border: 1px solid #007bff; border-radius: 5px;">
