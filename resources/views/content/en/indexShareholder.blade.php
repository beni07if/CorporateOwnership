        ...
        <div class="row">
          ...
          <div class="col-xl-12">
            ...
            <form action="{{ route('searchFunctionShareholder') }}" method="GET" class="d-flex ms-auto" style="width: 33%;">
                <input type="text" class="form-control me-2" name="shareholder_name" placeholder="Search for other shareholders">
                              ...
                              <div class="col-lg-12 col-md-6 mb-4">
                                  <h5 class="card-title">
                                      <form action="{{ route('subsidiaryShow') }}" method="POST" style="display: inline;">
                                          ...
                                          <button type="submit" style="background: none; border: none; font-size:17px; color: #012970; cursor: pointer; font-weight: bold; transition: color 0.3s;" 
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6 col-md-6">
                                          <div class="row">
                                              ...
                                              <div class="col-lg-7 col-md-8">
                                                  : {{ $shareholder->number_of_shares ?? '-' }} ({{ $shareholder->currency ?? '-' }})
                                              </div>
                                          </div>  
                                      </div>
                                      <div class="col-lg-6 col-md-6">
