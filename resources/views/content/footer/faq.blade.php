        ...
        <div class="card-body">
          ...
          <div class="accordion-item">
            ...
            <div class="accordion-body">
              Corporate Profile adalah platform digital yang dikembangkan untuk menyajikan informasi mengenai
              sebuah perusahaan yang meliputi profil perusahaan, struktur kepemilikan saham, individu ownership
              dan sustainability risk assessment dari perusahaan tersebut.
            </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            ...
            <div class="accordion-body">
              Corporate Profile fokus pada menyajikan informasi spesifik struktur kepemilikan perusahaan,
              individual ownership serta penilaian SRA. Sementara website perusahaan lain tidak menampilkan
              informasi tersebut.
            </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            ...
            <div class="accordion-body">
              Anda dapat mengakses Corporate Profile perusahaan dengan mengunjungi website resmi perusahaan
              tersebut. Untuk mengakses fitur utama dari website ini anda dapat mengklik menu Feature. Untuk
              mengakses fitur ini anda harus login terlebih dahulu. Jika Anda belum memiliki akun, Anda dapat
              menghubungi tim kami di helpdesk@earthqualizer.org.
            </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            ...
            <div class="accordion-body">
              Untuk saat ini mayoritas perusahaan yang masuk dalam corporate profil adalah yang bergerak di
              industri kelapa sawit, dan sebagian yang lain dari industri ekstraksi lainnya.
            </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
            <button class="accordion-button collapsed" data-bs-target="#faqsOne-6" type="button"
              data-bs-toggle="collapse">
              Bagaimana cara menemukan informasi lebih lanjut tentang sebuah perusahaan melalui Corporate
              Profile?
            </button>
            </h2>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
            <button class="accordion-button collapsed" data-bs-target="#faqsOne-7" type="button"
              data-bs-toggle="collapse">
              Apa itu SRA?
            </button>
            </h2>
            ...
            <div class="accordion-body">
              Sustainability Risk Assessment (SRA) adalah penilaian sistematis berbasis grup untuk
              mengidentifikasi, analisis, dan mengelola risiko yang berdampak pada keberlanjutan dari
              perusahaan.
            </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
            <button class="accordion-button collapsed" data-bs-target="#faqsOne-8" type="button"
              data-bs-toggle="collapse">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
            <button class="accordion-button collapsed" data-bs-target="#faqsOne-9" type="button"
              data-bs-toggle="collapse">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
            <button class="accordion-button collapsed" data-bs-target="#faqsOne-10" type="button"
              data-bs-toggle="collapse">
