...
<body>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="row mb-3" hidden>
            ...
            <div class="col-md-6">
                <input id="user_level" type="text" class="form-control @error('user_level') is-invalid @enderror" name="user_level" value="1" required autocomplete="user_level" autofocus>
